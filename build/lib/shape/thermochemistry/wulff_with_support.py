...
Modified version:
Added the possibility to include support effects by specifying the 
Miller index (hkl) of the facet in contact with the support and the
corresponding specific adhesion energy.
The class WulffShape has now two new arguments: miller_supp and e_surf_supp.
Modifications done by Raffaele Cheula, LCCP, Politecnico di Milano.
"""
...
__author__ = 'Zihan Xu, Richard Tran, Shyue Ping Ong, {Raffaele Cheula}'
__copyright__ = 'Copyright 2013, The Materials Virtual Lab'
__version__ = '0.1'
__maintainer__ = 'Zihan Xu'
__email__ = 'zix009@eng.ucsd.edu {raffaele.cheula@polimi.it}'
__date__ = 'May 5 2016 {June 2018}'
...
class WulffShape(object):
    ...
    def miller_energy_dict(self):
        ...
        """
        return OrderedDict(zip(self.miller_list, self.e_surf_list))
    ...
    def area_fraction_dict(self):
        ...
        for hkl in self.miller_area_dict.keys():
            area_dict[hkl] = self.miller_area_dict[hkl] / self.surface_area
        return area_dict
